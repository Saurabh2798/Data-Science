...
### 5. [Q-A bot](https://github.com/Saurabh2798/Q-A-bot)
    A Question answering bot that can answer questions based on a story given to it. It is trained using the end-to-end memory network on a subset of the Facebook babi dataset.
